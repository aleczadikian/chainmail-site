...
4. Messages and connections may be used internally for analysis, in which case the data will be anonymized.
5. Anonymous usage-related data may be collected. This is described in greater detail in the EULA.
